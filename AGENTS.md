...
# 🔮 Obscura — Agent Instructions

## Project

Confidential B2B Invoice Settlement & Double-Factoring Fraud Prevention on Stellar.
...
- `contract/` — Soroban smart contract source code (`ObscuraSettlement`, `UltraHonkVerifier`)
- `circuit/` — Noir range-proof constraint circuits
- `src/app/` — Next.js 16 App Router pages & API routes
- `src/lib/` — Shared client libraries, cryptographic utilities
...
- **Colors** = Cyan (#06b6d4) for primary accent, Emerald (#10b981) for success/payouts, Slate (#1e293b) for backgrounds
